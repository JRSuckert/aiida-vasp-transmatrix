...
Check version number in setup.json and aiida_vasp_transmatrix/__init__.py and make sure
they match.
"""
...
import aiida_vasp_transmatrix  # pylint: disable=wrong-import-position
version = aiida_vasp_transmatrix.__version__
...
if version != setup_content['version']:
    ...
    print("Version number in '{}/__init__.py': {}".format(
        'aiida_vasp_transmatrix', version))
    sys.exit(1)
