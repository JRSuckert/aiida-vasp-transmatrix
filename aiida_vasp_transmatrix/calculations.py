"""
Calculations provided by aiida_vasp_transmatrix.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.input('metadata.options.parser_name', valid_type=six.string_types, default='transmatrix')
        ...
        spec.output('transmatrix', valid_type=SinglefileData, help='diff between file1 and file2.')
